...
from .views import (Home, VerCarritoView, ActualizarCarritoView,
                    ...
                    DetalleProducto)#,AgregarProductoCarritoDesdeListaView)
...
urlpatterns = [
    ...
    # path('agregar-producto-carrito-2', AgregarProductoCarritoDesdeListaView.as_view(), name='agregar-producto-carrito'),
