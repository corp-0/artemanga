    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_expiracion', models.DateField(blank=True, help_text='Si la auto expiración está "activa", la campaña pasará a estar "inactiva" una vez alcanzada la fecha indicada, de otro modo no tiene efecto.de otro modo no tiene efecto.', null=True, verbose_name='Fecha expiración')),
